...
\newcommand*{\mytitle}{Laboratori d'alguna cosa}
\newcommand*{\mysubtitle}{Nom de la pràctica}
\newcommand*{\myauthor}{Alfredo Hernández Cavieres \and John Smith}
...
% \part{Informes}
	\include{./contents/1-introduccio}
	\include{./contents/2-metodologia}
	\include{./contents/3-resultats}

\appendix
% \part*{Annexos}
% \addcontentsline{toc}{part}{Annexos}
	\include{./contents/A-incerteses}
